const confettiContainer = document.getElementById('confetti-container'); // IDで取得
    ...
    function animateLoop() {
        // cracker-containerが表示されているときのみ実行
        if (!document.getElementById('cracker-container').classList.contains('active')) {
             return;
        }
