...
const fruits = [
    { element: document.getElementById('tomato'), startX: 0, startY: 0 },
...
const tomato_list = document.getElementById("tomato_list");
...
fruits.forEach(fruitInfo => {
    ...
    fruitElement.addEventListener('click', () => {
		...
		if(fruitElement.id == 'tomato') tomato_cnt++;
		console.warn(yam_cnt, potato_cnt, greenpepper_cnt, tomato_cnt);
